<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="Saga.GMD.Adobe.Anonymisation.WebUtility.Account.OpenAuthProviders" %>
